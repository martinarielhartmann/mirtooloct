    ...
    if iscell(y)
        ...
        for i = 1:l
            ...
            if lx < 6
                ...
                %%%% positions
                ttt = unique(round(fp(:).* 10000)./ 10000); % rounding to 4 decimals due to a strange numerical precision of frame positions
